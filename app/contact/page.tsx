    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-16 flex items-center border-b">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-6">
          ...
          <Link className="text-sm font-medium hover:underline underline-offset-4" href="/campaigns">Campaigns</Link>
          ...
          <div className="container px-4 md:px-6">
            <div className="space-y-4">
              <Card>
                ...
                <CardContent>
                  <form
                    action="https://formspree.io/f/mnnzakbv"
                    method="POST"
                    className="space-y-4"
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea id="message" name="message" className="min-h-[120px]" placeholder="Enter your message" required />
                    </div>
